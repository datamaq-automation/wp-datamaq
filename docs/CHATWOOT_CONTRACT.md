...
- **Intercepción de SPA:** Existe un "Debug Gateway" en `index.html` que intercepta llamadas de la SPA compilada para redirigirlas a WordPress.
...
7. **Atribución de Marketing:** Se capturan automáticamente parámetros UTM, Referrer y Landing Page. Estos datos se aplanan y se envían como `custom_attributes` al contacto en Chatwoot para permitir análisis de ROI.
