...
$view_model = new \DataMaq\UI\ViewModels\ContactPageViewModel( dm_content_repo() );
?>
			...
			<div class="tw:grid tw:grid-cols-1 lg:tw:grid-cols-12 tw:gap-8 tw:items-stretch">
				...
				<div class="tw:col-span-1 lg:tw:col-span-5">
					<article class="c-contact-page-panel c-contact-page-panel--intro">
						...
						<h1 id="contact-page-title" class="c-contact-page-title"><?php echo esc_html( $view_model->getTitle() ); ?></h1>
						<p class="c-contact-page-copy"><?php echo esc_html( $view_model->getIntroCopy() ); ?></p>
						<div class="c-contact-page-chips" aria-label="Accesos a la home">
							<a href="<?php echo esc_url( $view_model->getServicesLink() ); ?>" class="c-contact-page-chip">Soluci&oacute;n</a>
				...
				<div class="tw:col-span-1 lg:tw:col-span-7">
					<article class="c-contact-page-panel c-contact-page-panel--support">
						...
						<ul class="c-contact-page-support-list">
							<?php foreach ( $view_model->getSupportChannels() as $channel ) : ?>
								<li><?php echo esc_html( $channel ); ?></li>
							<?php endforeach; ?>
						</ul>
						<div class="c-contact-page-support-actions">
							...
							<a href="<?php echo esc_url( $view_model->getHomeLink() ); ?>" class="btn c-ui-btn c-ui-btn--outline">Volv&eacute; al inicio</a>
						</div>
					</article>
				</div>
				...
				<div data-v-9736d982="" class="card c-ui-card tw:border-orange-500/30 tw:border-2 tw:shadow-sm tw:bg-dm-surface/50 tw:backdrop-blur-sm tw:rounded-2xl tw:mb-6">
					<div class="card-body tw:p-6 tw:text-center">
						<div class="c-tecnico-avatar tw:mx-auto tw:mb-4">
							<img src="<?php echo esc_url( $view_model->getTechnicianAvatar() ); ?>" alt="Foto del t&eacute;cnico a cargo" class="tw:rounded-full tw:border-4 tw:border-orange-500/20" width="100" height="100" loading="lazy">
						</div>
						<p class="tw:text-xs tw:font-black tw:uppercase tw:text-orange-500 tw:tracking-widest tw:mb-1">T&eacute;cnico a cargo</p>
						<h3 class="tw:text-xl tw:font-bold tw:mb-4"><?php echo esc_html( $view_model->getTechnicianName() ); ?></h3>
