...
<section id="servicios" data-dm-component="ScrollReveal" class="section-mobile c-home-services" aria-labelledby="servicios-title">
	<div class="tw:container tw:mx-auto tw:px-4">
		<div class="c-home-section-head">
			...
			<h2 id="servicios-title" class="c-home-section-title"><?php echo esc_html( $viewModel->getTitle() ); ?></h2>
			<p class="c-home-section-copy"><?php echo esc_html( $viewModel->getIntro() ); ?></p>
		</div>

		<div class="c-home-services__grid">
			<?php foreach ( $viewModel->getServices() as $service ) : ?>
