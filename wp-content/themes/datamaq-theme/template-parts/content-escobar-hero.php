...
<section data-dm-component="ScrollReveal" class="tw:py-16 lg:tw:py-24 tw:bg-[#0c092f]" aria-labelledby="escobar-hero-title">
    <div class="tw:container tw:mx-auto tw:px-4">
        <div class="tw:max-w-4xl">
            ...
            <h1 id="escobar-hero-title" class="tw:text-5xl lg:tw:text-7xl tw:font-black tw:text-white tw:mb-8 tw:tracking-tighter tw:leading-[0.9]">
                <?php echo esc_html($data['headline']); ?>
            </h1>
            <p class="tw:text-2xl tw:text-white/70 tw:mb-12 tw:leading-tight tw:font-medium">
                <?php echo esc_html($data['lead']); ?>
            </p>
            
            <div class="tw:flex tw:flex-col sm:tw:flex-row tw:gap-6">
                <a href="https://wa.me/5491156297160" class="tw:btn-primary tw:px-12 tw:py-5 tw:text-xl tw:font-black tw:text-center">
                    Escribime por WhatsApp
                </a>
                <a class="tw:btn-outline tw:px-12 tw:py-5 tw:text-xl tw:text-center" href="#contacto">
