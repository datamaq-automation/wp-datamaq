        ...
        <div class="tw:max-w-5xl tw:mx-auto">
            ...
            <div class="tw:grid tw:grid-cols-1 lg:tw:grid-cols-12 tw:gap-16 tw:items-start">
                ...
                <div class="lg:tw:col-span-12 tw:text-center tw:mb-8">
                    ...
                    <h2 class=" tw:text-4xl lg:tw:text-6xl tw:mt-4">Iniciar proyecto</h2>
                </div>
                ...
                <div class="lg:tw:col-span-10 lg:tw:col-start-2 tw:p-8 lg:tw:p-12 dm-contact-card">
                    ...
                    <div class="tw:mb-16">
                        <div class="tw:flex tw:items-center tw:justify-between tw:mb-4">
                            <span id="step-indicator" class="/40 tw:text-[10px] tw:font-black tw:uppercase tw:tracking-widest">Paso 1 de 3</span>
                    ...
                    <form id="dm-contact-form" action="#" method="POST" data-dm-component="ContactWizard">
                        ...
                        <div class="dm-form-step" id="step-1">
                            <div class="tw:space-y-12">
                                <h3 class=" tw:text-2xl tw:font-black tw:tracking-tight">&iquest;C&oacute;mo te llamas?</h3>
                        ...
                        <div class="dm-form-step tw:hidden" id="step-2">
                            <div class="tw:space-y-12">
                                ...
                                <div class="tw:space-y-3">
                                    <label class="/40 tw:text-[10px] tw:font-black tw:uppercase tw:tracking-widest">Consulta t&eacute;cnica o comercial</label>
                                    <textarea name="dm_message" required rows="6" placeholder="&iquest;En qu&eacute; podemos ayudarte?" class="dm-input-v6 "></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="dm-form-step tw:hidden" id="step-3">
                            <div class="tw:space-y-12">
                                <h3 class=" tw:text-2xl tw:font-black tw:tracking-tight">V&iacute;a de contacto</h3>
                                ...
                                <p class="/30 tw:text-xs tw:text-center">Al elegir WhatsApp, abrir&aacute; un chat directo con tu mensaje listo para enviar.</p>
                            </div>
                        </div>
                        ...
                        <div class="tw:mt-16 tw:flex tw:gap-4">
                            ...
                            <button type="button" id="btn-next" class="tw:flex-[2]  tw:rounded-2xl tw:bg-[#ff6a00] tw:text-[#0c092f] tw:font-black tw:uppercase tw:tracking-widest tw:text-[10px] tw:transition-all hover:tw:scale-[1.02]">Siguiente paso</button>
                             <button type="submit" id="btn-submit" class="tw:hidden tw:flex-[2]  tw:rounded-2xl tw:bg-[#ff6a00] tw:text-[#0c092f] tw:font-black tw:uppercase tw:tracking-widest tw:text-[10px] tw:transition-all hover:tw:scale-[1.02]">Finalizar env&iacute;o</button>
                        </div>
                    </form>
