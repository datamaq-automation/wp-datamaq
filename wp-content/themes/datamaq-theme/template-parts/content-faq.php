 ...
 */
try {
	$view_model = new \DataMaq\UI\ViewModels\FaqViewModel( dm_content_repo() );
} catch ( \Throwable $e ) {
...
<section id="faq" data-dm-component="ScrollReveal" class="section-mobile c-home-faq" aria-labelledby="faq-title">
	<div class="tw:container tw:mx-auto tw:px-4">
		<div class="c-home-section-head">
			...
			<h2 id="faq-title" class="c-home-section-title"><?php echo esc_html( $view_model->getTitle() ); ?></h2>
		</div>

		<div class="c-home-faq__stack">
			<?php foreach ( $view_model->getItems() as $faq ) : ?>
